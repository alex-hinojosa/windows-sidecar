...
var (
	// TmuxInteractiveInput enables write support for tmux-compatible mux panes.
	TmuxInteractiveInput = Feature{
		Name:        "tmux_interactive_input",
		Default:     true,
		Description: "Enable write support for psmux/tmux panes",
	}

	// TmuxInlineEdit enables inline file editing via tmux-compatible mux in the files plugin.
	TmuxInlineEdit = Feature{
		Name:        "tmux_inline_edit",
		Default:     true,
		Description: "Enable inline file editing via psmux/tmux in the files plugin",
	}
